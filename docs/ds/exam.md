...
| 정/컴 | 교시 | 번호 | 문제 | 관련토픽 |
|:------|:----:|:----:|:-----|:---------|
| 관리 | 1 | 1 | [멀티미디어 스트리밍 프로토콜의 종류]({{ site.baseurl }}/docs/nw/07-osi-layer/streaming-protocol) | 스트리밍기술 |
| 관리 | 1 | 3 | MODBUS 프로토콜을 설명하시오 | 스마트 그리드 |
| 관리 | 1 | 9 | A/B 테스팅을 설명하시오 | 모바일 마케팅 |
...
| 컴시응 | 4 | 2 | AIaaS(AI as a Service)의 개념, 특징 및 도입 시 고려사항에 대하여 설명하시오 | XaaS |
