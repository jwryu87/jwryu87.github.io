...
| 특징 | 설명 |
|:-----|:-----|
| **호스트OS 공유** | Guest OS 없이 Host OS 커널 공유 |
| **빠르고 가벼운 가상화** | 컨테이너 단위 경량 가상화 |
| **자유로운 개발환경** | 개발언어, 툴 무관 |
| **이식성** | 환경 독립적 배포 가능 |
| **개발/운영 호환성** | Copy → Run 과정만으로 배포 |
| **DevOps** | 개발과 운영의 통합 지원 |
...
| **Namespace** | 운영 환경 고립 (프로세스, 네트워크, 마운트 등) |
| **Libvirt** | Lib + Virtualization, Container에게 API 제공 |
| **Container** | 독립 공간, Container 간 내부 공유 안됨 |
