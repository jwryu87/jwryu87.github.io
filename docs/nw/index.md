...
[IoT]({{ site.baseurl }}/docs/nw/01-iot){: .btn .btn-outline-purple .fs-5 .mb-4 .mb-md-0 .mr-2 }
[Ad-hoc]({{ site.baseurl }}/docs/nw/02-adhoc){: .btn .btn-outline-blue .fs-5 .mb-4 .mb-md-0 .mr-2 }
[NW기본]({{ site.baseurl }}/docs/nw/03-fundamentals){: .btn .btn-outline-green .fs-5 .mb-4 .mb-md-0 .mr-2 }
[NW구축]({{ site.baseurl }}/docs/nw/04-infrastructure){: .btn .btn-outline-red .fs-5 .mb-4 .mb-md-0 }

[QoS]({{ site.baseurl }}/docs/nw/05-qos){: .btn .btn-outline-orange .fs-5 .mb-4 .mb-md-0 .mr-2 }
[NW관리]({{ site.baseurl }}/docs/nw/06-management){: .btn .btn-outline-teal .fs-5 .mb-4 .mb-md-0 .mr-2 }
[OSI7Layer]({{ site.baseurl }}/docs/nw/07-osi-layer){: .btn .btn-outline-pink .fs-5 .mb-4 .mb-md-0 .mr-2 }
[이동통신]({{ site.baseurl }}/docs/nw/08-mobile){: .btn .btn-outline-indigo .fs-5 .mb-4 .mb-md-0 }
