...
> - (특징) `스메보` (스텔스, 메모리상주, 보안우회)
> - (차이점) `연데탐포로은개공네탐동배방` (연결주체, 데이터전달, 탐지가능성, 포트사용, 로그흔적, 은폐수준, 개념, 공격대상, 네트워크채널, 탐지난이도, 동작계층, 배포방식, 방화벽우회)
...
**비교 구분자**: 연결주체, 데이터전달, 탐지가능성, 포트사용, 로그흔적, 은폐수준, 개념, 공격대상, 네트워크채널, 탐지난이도, 동작계층, 배포방식, 방화벽우회
