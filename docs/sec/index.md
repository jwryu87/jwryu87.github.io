...
[암호기술]({{ site.baseurl }}/docs/sec/01-cryptography){: .btn .btn-outline-purple .fs-5 .mb-4 .mb-md-0 .mr-2 }
[인증/접근통제]({{ site.baseurl }}/docs/sec/02-iam){: .btn .btn-outline-blue .fs-5 .mb-4 .mb-md-0 .mr-2 }
[네트워크보안]({{ site.baseurl }}/docs/sec/03-network-security){: .btn .btn-outline-green .fs-5 .mb-4 .mb-md-0 .mr-2 }
[클라우드/IoT]({{ site.baseurl }}/docs/sec/04-cloud-iot-smart){: .btn .btn-outline-red .fs-5 .mb-4 .mb-md-0 }

[사이버공격]({{ site.baseurl }}/docs/sec/05-cyber-attack){: .btn .btn-outline-orange .fs-5 .mb-4 .mb-md-0 .mr-2 }
[취약점]({{ site.baseurl }}/docs/sec/06-vulnerability){: .btn .btn-outline-teal .fs-5 .mb-4 .mb-md-0 .mr-2 }
[보안운영]({{ site.baseurl }}/docs/sec/07-security-operations){: .btn .btn-outline-pink .fs-5 .mb-4 .mb-md-0 .mr-2 }
[디지털포렌식]({{ site.baseurl }}/docs/sec/08-digital-forensics){: .btn .btn-outline-indigo .fs-5 .mb-4 .mb-md-0 }

[개인정보보호]({{ site.baseurl }}/docs/sec/09-privacy){: .btn .btn-outline-cyan .fs-5 .mb-4 .mb-md-0 .mr-2 }
[보안정책]({{ site.baseurl }}/docs/sec/10-policy-standard){: .btn .btn-outline-lime .fs-5 .mb-4 .mb-md-0 .mr-2 }
